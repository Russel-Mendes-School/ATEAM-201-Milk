...
public class FileManager
{
  ...
  public static String readFromFile(String path)
  {
    ...
    try
    {
      ...
      while (line != null)
      {
        ...
        if (tempArr.length == 3)
        {
          ...
          } catch (NumberFormatException e)// catch errors in integer formatting (numerical date/milk weight)
          {
            System.out.println(Arrays.toString(tempArr));
            dataFormatErrors++;
          }
    ...
    // Dynamic Responses - provide user with better understanding of load results
  ...
  public static String readFromDir(String path)
  {
    ...
    for (File file : files)
    {
      ...
      if (response != null)
      {
        message += "Error Occured in File: " + file.getAbsolutePath() + " : " + response + "\n";
      }
    }
    System.out.println();
    return message;
